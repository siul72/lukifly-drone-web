 ...
 */
public class TranslationUploader implements Upload.Receiver, Upload.SucceededListener {
    public File file;
    private static final Logger LOG = Logger.getLogger(TranslationUploader.class);
    private BeanUpdateForm parent;

    public OutputStream receiveUpload(String filename,
                                      String mimeType) {

        URL url = TranslationUploader.class.getClassLoader().getResource("uploads/");
        assert url != null;
        URI uriName = null;
        try {
    ...
    public void uploadSucceeded(Upload.SucceededEvent event) {
        ...
        parent.setTranslationFile(file);
